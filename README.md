# Manage your Kubernetes clusters using Natural Language with the Kubernetes Speech Assistant Android app
...
4. [Configure Watson Assistant](#4-build-a-network)
5. [Deploy Node.js server to Kubernetes](#5-deploy-fabcar-smart-contract-on-the-network)
6. [Configure Android Application](#4-build-a-network)
